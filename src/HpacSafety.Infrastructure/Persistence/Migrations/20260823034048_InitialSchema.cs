        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    help_en = table.Column<string>(type: "text", nullable: true),
                    help_fr = table.Column<string>(type: "text", nullable: true),
                    is_private = table.Column<bool>(type: "boolean", nullable: false),
                    sort_order = table.Column<int>(type: "integer", nullable: false),
                    is_active = table.Column<bool>(type: "boolean", nullable: false),
                    section_key = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    supersedes_question_id = table.Column<string>(type: "char(11)", fixedLength: true, maxLength: 11, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_questions_questions_supersedes_question_id",
                        column: x => x.supersedes_question_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_question_options_question_id_code",
                table: "question_options",
                columns: new[] { "question_id", "code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_questions_key_is_active_revision",
                table: "questions",
                columns: new[] { "key", "is_active", "revision" });

            migrationBuilder.CreateIndex(
                name: "ix_questions_key_revision",
                table: "questions",
                columns: new[] { "key", "revision" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_questions_supersedes_question_id",
                table: "questions",
                column: "supersedes_question_id",
                unique: true);
