...
| [0006 — An internal identifier leaked into the authoring screen](0006-an-internal-identifier-leaked-into-the-authoring-screen.md) | Administrators asked for an option "Code" they had no way to know | `REQ-QB-090`, `REQ-QB-092` |
