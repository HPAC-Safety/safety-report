...
namespace HpacSafety.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925213420_StoreYesOrNoInTheReportersLanguage")]
    partial class StoreYesOrNoInTheReportersLanguage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HpacSafety.Core.Features.Reporting.ReportAnswer", b =>
                {
                    ...
                    b.ToTable("report_answers", null, t =>
                        {
                            t.HasCheckConstraint("ck_report_answers_translation_mode", "translation_mode IN ('none', 'choice', 'machine', 'fixed')");
                        });
                });
