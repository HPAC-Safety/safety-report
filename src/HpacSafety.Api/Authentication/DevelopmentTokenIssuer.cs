...
public sealed class DevelopmentTokenIssuer
{
    ...
    public DevelopmentToken? Issue(string? username, string? password)
    {
        ...
        var token = new JwtSecurityToken(
            ...
            signingCredentials: new SigningCredentials(KeyFrom(signingKey), SecurityAlgorithms.HmacSha256));
...
public sealed record DevelopmentToken(
    string AccessToken, DateTimeOffset ExpiresAt, string Subject, MemberRole Role);
