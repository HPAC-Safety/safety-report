...
| `option_set_items` | ID, option-set ID, stable option code, EN/FR label, sort order, Deleted. Unique set + code, including across a removed item, so re-adding a code revives that row rather than creating a rival. |
