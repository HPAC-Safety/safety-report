...
public sealed class MediaIngestOutcome
{
	...
	public static MediaIngestOutcome Retained(
		...
		BlobKey originalKey)
	{
		return new MediaIngestOutcome(MediaIngestStatus.AwaitingStripping, MediaRejectionReason.None, contentType, byteSize, sha256, originalKey, default, null);
	}
	...
	public static MediaIngestOutcome Ingested(
		...
		DateTimeOffset strippedAt)
	{
		return new MediaIngestOutcome(MediaIngestStatus.Stripped, MediaRejectionReason.None, contentType, byteSize, sha256, originalKey, derivativeKey, strippedAt);
	}
}
