...
# DEEPL_API_KEY reaches the API and the Worker, GEMINI_API_KEY the Worker
# (docker-compose.yml). A missing one is named rather than discovered later as
# a failed translation or summary.
