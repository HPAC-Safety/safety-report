...
| Abuse prevention | Turnstile and its infrastructure are removed (ADR-0068); the submission endpoint requires a valid member bearer token (#14), but no rate limit yet (#15). | Enforce trusted-IP rate limits (#15). |
