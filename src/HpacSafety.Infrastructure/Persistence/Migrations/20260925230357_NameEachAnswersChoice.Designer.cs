...
namespace HpacSafety.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925230357_NameEachAnswersChoice")]
    partial class NameEachAnswersChoice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HpacSafety.Core.Features.Outbox.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("outbox_messages", null, t =>
                        {
                            t.HasCheckConstraint("ck_outbox_messages_type", "type IN ('summarize_report', 'process_attachment', 'translate_answers', 'translate_comment')");
                        });
                });
