...
namespace HpacSafety.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260926190248_AllowFutureDatesOnDateQuestions")]
    partial class AllowFutureDatesOnDateQuestions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HpacSafety.Core.Features.PrivateAttachments.PrivateAttachment", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(11)
                        .HasColumnType("char(11)")
                    ...
                    b.Property<string>("AddedBySubject")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("added_by_subject");
                    ...
                    b.Property<string>("DeletedBySubject")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("deleted_by_subject");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_report_private_attachments");

                    b.HasIndex("BlobKey")
                        .IsUnique()
                        .HasDatabaseName("ix_report_private_attachments_blob_key");

                    b.HasIndex("ReportId", "AddedAt")
                        .HasDatabaseName("ix_report_private_attachments_report_id_added_at");

                    b.ToTable("report_private_attachments", null, t =>
                        {
                            t.HasCheckConstraint("ck_report_private_attachments_byte_size", "byte_size > 0");
                        });
                });
            ...
            modelBuilder.Entity("HpacSafety.Core.Features.PrivateNotes.PrivateNoteRevision", b =>
                {
                    ...
                    b.HasIndex("AttachmentId")
                        .HasDatabaseName("ix_report_private_note_revisions_attachment_id");
            ...
            modelBuilder.Entity("HpacSafety.Core.Features.QuestionBank.QuestionChoice", b =>
                {
                    ...
                    b.Property<string>("MergedIntoChoiceId")
                        .HasMaxLength(11)
                        .HasColumnType("char(11)")
                        .HasColumnName("merged_into_choice_id")
                        .IsFixedLength();
                    ...
                    b.Property<string>("ReplacedByChoiceId")
                        .HasMaxLength(11)
                        .HasColumnType("char(11)")
                        .HasColumnName("replaced_by_choice_id")
                        .IsFixedLength();
            ...
            modelBuilder.Entity("HpacSafety.Core.Features.QuestionBank.QuestionRevision", b =>
                {
                    ...
                    b.Property<string>("DependsOnChoiceId")
                        .HasMaxLength(11)
                        .HasColumnType("char(11)")
                        .HasColumnName("depends_on_choice_id")
                        .IsFixedLength();
                    ...
                    b.HasIndex("DependsOnChoiceId")
                        .HasDatabaseName("ix_question_revisions_depends_on_choice_id");
            ...
            modelBuilder.Entity("HpacSafety.Core.Features.PrivateAttachments.PrivateAttachment", b =>
                {
                    b.HasOne("HpacSafety.Core.Features.Reporting.Report", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_report_private_attachments_reports_report_id");
                });
            ...
            modelBuilder.Entity("HpacSafety.Core.Features.PrivateNotes.PrivateNoteRevision", b =>
                {
                    b.HasOne("HpacSafety.Core.Features.PrivateAttachments.PrivateAttachment", null)
                        .WithMany()
                        .HasForeignKey("AttachmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_report_private_note_revisions_report_private_attachments_at~");
            ...
            modelBuilder.Entity("HpacSafety.Core.Features.QuestionBank.QuestionChoice", b =>
                {
                    ...
                    b.HasOne("HpacSafety.Core.Features.QuestionBank.QuestionChoice", null)
                        .WithMany()
                        .HasForeignKey("ReplacedByChoiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_question_choices_question_choices_replaced_by_choice_id");
            ...
            modelBuilder.Entity("HpacSafety.Core.Features.QuestionBank.QuestionRevision", b =>
                {
                    b.HasOne("HpacSafety.Core.Features.QuestionBank.QuestionChoice", null)
                        .WithMany()
                        .HasForeignKey("DependsOnChoiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_question_revisions_question_choices_depends_on_choice_id");
