...
#pragma warning disable CA1822 // Reqnroll step bindings must be instance methods to be discovered.
    ...
    public void GivenAnOrdinaryQuestion() => _question = Ordinary("occurrence_notes", QuestionType.LongText);

    [When(@"they mark it as one reporters must answer")]
    public void WhenTheyMarkItRequired() => Revise(isRequired: true);
    ...
    public void GivenARevisionCopiedAnOption() => GivenARevisionBuiltFromAList();
    ...
    public void ThenTheRevisionHoldsItsOwnCopy()
    {
        ...
        _snapshotted.Options.Select(option => option.Code)
            .ShouldBe(["golden", "lumby", "pemberton"], ignoreOrder: true);
    }
    ...
    public void WhenAnOptionIsRemoved() => _optionSet!.Remove("lumby", Noon.AddHours(1));
    ...
    public void ThenTheCopyIsUnchanged() => _snapshotted!.Option("lumby")!.LabelEn.ShouldBe("Lumby");
    ...
    public void WhenAnotherQuestionDependsOnIt() =>
        _rejection = Record(() =>
            QuestionDependencies.EnsureDependencyAllowed(_questions, childId: null, _questions[0].Id));
    ...
    public void ThenTheAttemptIsRejected() => _rejection.ShouldBeOfType<DomainRuleViolationException>();
    ...
    public void ThenAYesNoQuestionIsAccepted()
    {
        ...
        Should.NotThrow(() => QuestionDependencies.EnsureDependencyAllowed(_questions, childId: null, parent.Id));
    }
    ...
    {
        _questions.Add(Ordinary("occurrence_date", QuestionType.Date, displayOrder: 0));
        _questions.Add(Ordinary("occurrence_time", QuestionType.Time, displayOrder: 1));
        _questions.Add(Ordinary("occurrence_notes", QuestionType.LongText, displayOrder: 2));
